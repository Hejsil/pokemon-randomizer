...
pub fn main() !void {
    ...
    for (args[1..]) |arg| {
        ...
        if (findInfoInFile(&file, allocator)) |info| {
...
fn findInfoInFile(file: &os.File, allocator: &mem.Allocator) !Info {
    ...
    const hms = []u8 { 0x0f, 0x00, 0x13, 0x00, 0x39, 0x00, 0x46, 0x00, 0x94, 0x00, 0xf9, 0x00, 0x7f, 0x00, 0x23, 0x01 };
