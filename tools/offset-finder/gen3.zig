...
pub fn findInfoInFile(data: []const u8, version: common.Version) !Info {
    ...
    const maybe_trainers = switch (version) {
        ...
        common.Version.Ruby, common.Version.Sapphire => search.findStructs(gen3.Trainer, ignored_trainer_fields, data,
            constants.rs_first_trainers,
            constants.rs_last_trainers),
        common.Version.FireRed, common.Version.LeafGreen => search.findStructs(gen3.Trainer, ignored_trainer_fields, data,
    ...
    const base_stats = search.findStructs(gen3.BasePokemon, ignored_base_stat_fields, data,
    ...
    const maybe_items = switch (version) {
        ...
        common.Version.Ruby, common.Version.Sapphire => search.findStructs(gen3.Item, ignored_item_fields, data,
            constants.rs_first_items,
            constants.rs_last_items),
        common.Version.FireRed, common.Version.LeafGreen => search.findStructs(gen3.Item, ignored_item_fields, data,
