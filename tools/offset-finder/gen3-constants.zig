...
pub const first_tm_hm_learnsets = []Little(u64) {
    Little(u64){ .bytes = []u8{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, } }, // Dummy Pokémon
    Little(u64){ .bytes = []u8{ 0x20, 0x07, 0x35, 0x84, 0x08, 0x1e, 0xe4, 0x00, } }, // Bulbasaur
    Little(u64){ .bytes = []u8{ 0x20, 0x07, 0x35, 0x84, 0x08, 0x1e, 0xe4, 0x00, } }, // Ivysaur
    Little(u64){ .bytes = []u8{ 0x30, 0x47, 0x35, 0x86, 0x08, 0x1e, 0xe4, 0x00, } }, // Venusaur
};

pub const last_tm_hm_learnsets = []Little(u64) {
    Little(u64){ .bytes = []u8{ 0x3e, 0xd6, 0xbb, 0xb7, 0x93, 0x5e, 0x5c, 0x03, } }, // Latios
    Little(u64){ .bytes = []u8{ 0x2c, 0xc6, 0x9b, 0xb5, 0x93, 0x8e, 0x40, 0x00, } }, // Jirachi
    Little(u64){ .bytes = []u8{ 0x2d, 0xde, 0xbb, 0xf5, 0xc3, 0x8f, 0xe5, 0x00, } }, // Deoxys
    Little(u64){ .bytes = []u8{ 0x28, 0x8e, 0x1b, 0xb4, 0x03, 0x9f, 0x41, 0x00, } }, // Chimecho
};
